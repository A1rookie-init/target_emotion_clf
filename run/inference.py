...
parser = argparse.ArgumentParser(prog="train", description="Inference Table to Text with kcelectra")
...
parser.add_argument("--max-seq-len", type=int, default=150, help="summary max sequence length")
